...
function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto', backgroundColor: '#f1f8e9', minHeight: '100vh', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif' }}>
      ...
      <style>
        {`@keyframes blink {
          0%, 50% { opacity: 1; text-shadow: 0 0 5px #FF9800; }
          51%, 100% { opacity: 0.7; text-shadow: none; }
        }`}
      </style>

      <footer style={{ textAlign: 'center', marginTop: '40px', padding: '20px', backgroundColor: '#4CAF50', color: 'white', borderRadius: '10px' }}>
        <p style={{ margin: 0, fontSize: '16px' }}>For enquiries: <a href="https://wa.me/254705245123" target="_blank" rel="noopener noreferrer" style={{ marginRight: '20px', textDecoration: 'none', animation: 'blink 2s infinite' }}>
        ...
        </a> | <a href="https://x.com/B_D_coach_app" target="_blank" rel="noopener noreferrer" style={{ marginRight: '20px', textDecoration: 'none', animation: 'blink 2s infinite' }}>
        ...
        </a> | <a href="https://www.tiktok.com/@budget_and_debt_coach" target="_blank" rel="noopener noreferrer" style={{ marginLeft: '20px', textDecoration: 'none', animation: 'blink 2s infinite' }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
